...
export interface MockFAssetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockFAsset extends BaseContract {
  connect(runner?: ContractRunner | null): MockFAsset;
  waitForDeployment(): Promise<this>;

  interface: MockFAssetInterface;
